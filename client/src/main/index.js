...
let ChatWriter = function (player) {
  ...
  context.drawImage(
    ...
    player.y - margin - 35 - chatarray.length * 40 + textfloater,
    290,
    chatarray.length * 40
  );
  context.drawImage(
    chatboxTop,
    num + DisplayCenter - oneline * 20 - 20,
    player.y - margin - chatarray.length * 40 - 30 - 15 - 5 + textfloater
  );
  context.drawImage(
    chatboxUnder,
    num + DisplayCenter - oneline * 20 - 20,
    player.y - margin - 30 - 5 + textfloater
  );
  ...
  for (let i = 0; i < chatarray.length; i++) {
    ...
    context.fillText(
      ...
      player.y - margin + DisplayTop - (chatarray.length - i) * 40 + textfloater
    );
  }
  chatarray = [];
};
...
let NameWriter = function (player) {
  ...
  context.fillText(
    ...
    player.y - 30 + DisplayTop + textfloater
  );
  bufferSize = 0;
};
//-----------------------------------
...
let SmokeDrawer = function (player) {
  if (!smoke.Animated) {
    ...
    switch (player.frameX) {
      case player.width * 4:
        smoke.FrameX = smoke.width * 0;
        break;
      case player.width * 5:
        smoke.FrameX = smoke.width * 1;
        break;
      case player.width * 6:
        smoke.FrameX = smoke.width * 2;
        break;
      case player.width * 7:
        smoke.FrameX = smoke.width * 3;
        smoke.Animated = true;
        break;
      default:
        return;
    ...
    context.drawImage(
      ...
      smoke.width,
      smoke.height,
      num + DisplayCenter - 240 + smoke.x,
      960 - player.height + smoke.y,
      smoke.width,
      smoke.height
    );
  }
    ...
    case "masi":
      {
        switch (player.smokeActionFrame) {
          case 0:
            ...
            break;
          case 1:
            player.frameX = player.width * 1;
            break;
          case 2:
            player.frameX = player.width * 2;
            break;
          case 3:
            player.frameX = player.width * 3;
            break;
          case 4:
            player.frameX = player.width * 4;
            break;
          case 5:
            player.frameX = player.width * 5;
            break;
          case 6:
            player.frameX = player.width * 6;
            break;
          case 7:
            player.frameX = player.width * 7;
            break;
          case 8:
            player.frameX = player.width * 6;
            break;
          ...
          case 11:
            ...
            break;
          case 12:
            player.frameX = player.width * 8;
            break;
          case 13:
            player.frameX = player.width * 9;
            break;
          case 14:
            player.frameX = player.width * 3;
            break;
